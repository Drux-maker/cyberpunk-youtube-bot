"""
SEO metadata generation via OpenAI GPT-4o-mini.
Generates titles, descriptions, tags, chapters, and pinned comments.
"""
import json
import logging
import re
...
"""
    ...
    try:
        ...
        data = _fallback_metadata(style, duration_label, style_name, year)
...
def _fallback_metadata(style: MusicStyle, duration_label: str, style_name: str, year: int) -> dict:
    import random
    ...
    return {
        ...
        "chapters": _generate_chapters(3600),
        "pinned_comment": (
